        ...
        <div className="min-h-screen bg-white flex flex-col justify-center py-12 px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md animate-in zoom-in-95 duration-500">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8 w-full max-w-sm mx-auto">
                    ...
                    >
                        <Building2 className={`w-8 h-8 mb-2 ${signupType === 'BUSINESS' ? 'text-primary-600' : 'text-gray-400'}`} />
                    ...
                    >
                        <User className={`w-8 h-8 mb-2 ${signupType === 'TEAM' ? 'text-primary-600' : 'text-gray-400'}`} />
                ...
                <div className="bg-white py-8 px-4 shadow-xl border border-gray-100 sm:rounded-3xl sm:px-10">
                    <form className="space-y-6" onSubmit={handleSignup}>
                        ...
                        {signupType === 'BUSINESS' && (
                            <div className="bg-primary-50 p-4 rounded-xl border border-primary-100">
                                ...
                                <input
                                    type="text"
                                    required
                                    className="mt-1 block w-full px-3 py-2 border border-primary-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 sm:text-sm font-bold"
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input
                                        type="text"
                                        required
                                        className="focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 block w-full pl-10 sm:text-sm border-gray-200 rounded-xl py-3.5 bg-gray-50 font-medium"
                        ...
                        <div>
                            <Button
                                type="submit"
                                className="w-full flex justify-center py-4 text-base font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-700 shadow-xl shadow-primary-600/20 transition-all active:scale-[0.98]"
                                isLoading={isLoading}
                            >
                                {signupType === 'BUSINESS' ? 'Launch Platform' : 'Join Team'} <ArrowRight className="ml-2 w-5 h-5" />
                            </Button>
                        </div>
