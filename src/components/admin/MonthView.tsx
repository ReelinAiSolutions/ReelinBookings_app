        ...
        <div className="flex flex-col h-full bg-white animate-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between px-2 py-2 border-b border-gray-100 bg-white z-10 shrink-0">
                ...
                <button
                    ...
                    className="text-lg font-bold text-primary-600 flex items-center gap-1 hover:bg-primary-50 px-2 rounded-lg transition-colors group"
                >
                    <span className="text-purple-900/50 mr-1">Month</span>
                    {format(currentDate, 'MMMM yyyy')}
                    <ChevronRight className="w-4 h-4 text-purple-400 group-hover:text-primary-600 rotate-90 transition-transform" />
                </button>
                    ...
                    return (
                        ...
                        >
                            <span className={`
                                ...
                                ${isToday ? 'bg-primary-600 text-white font-bold shadow-sm' : ''}
                            ...
                            {hasEvents && (
                                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center justify-center pointer-events-none">
                                    {events.length === 1 ? (
                                        <div className="w-1.5 h-1.5 rounded-full bg-primary-400/60 shadow-sm shadow-primary-500/20"></div>
                                    ) : (
                                        <div className="flex items-center gap-[2px] px-1.5 py-0.5 rounded-full bg-primary-50/50 border border-purple-100/50 shadow-sm shadow-purple-500/10">
