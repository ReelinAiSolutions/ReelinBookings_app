                ...
                {viewMode === 'team' && (
                    <div className="flex w-full sticky top-0 z-40 bg-white border-b border-gray-300 shadow-sm">
                        ...
                        {staff.map((member, idx) => {
                            ...
                            return (
                                <div key={member.id} className="flex-1 min-w-0 text-center border-l border-gray-300 first:border-l-0 py-2 bg-white sticky top-0">
                        ...
                        {viewMode === 'personal' ? (
                            ...
                            <>
                                {staff.map((member, idx) => {
                                    ...
                                    return (
                                        <div key={member.id} className="flex-1 min-w-0 border-l border-gray-300 relative first:border-l-0 group h-full">
                                            {hours.map(h => (
