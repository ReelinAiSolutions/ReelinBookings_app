...
export default function StaffCard({ staff, services, onEdit, onSchedule, onDelete, appointmentCount = 0 }: StaffCardProps) {
    ...
    return (
        <div className="group relative bg-white rounded-[40px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.1)] hover:-translate-y-2">
            {/* Header Background */}
            <div className="h-24 relative overflow-hidden" style={getGradientStyle(staff.name)}>
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                    {appointmentCount > 0 && (
                        <div className="px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-full border border-white/20 shadow-sm flex items-center gap-1.5 transition-transform group-hover:scale-110">
            ...
            <div className="absolute top-10 left-8">
                <div className="w-20 h-20 rounded-[2rem] border-4 border-white shadow-2xl overflow-hidden bg-white group-hover:scale-105 transition-transform duration-500">
                    {hasAvatar ? (
                ...
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <span className="px-3 py-1 bg-gray-100 text-gray-500 text-[10px] font-black uppercase tracking-[0.2em] rounded-lg">
